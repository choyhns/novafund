...
<div id="modalBg" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; 
	...
	<div style="display: flex; align-items: center; width: 25%;">
        <input type="text" name="goalAmount" class="form-control" style="flex:1;"
           oninput="formatNumber(this);" value="0"/>
	...
	<div id="main_files">
	<input type="file" name="mainImages" multiple class="form-control"
	style="width: 30%;"/><br/>
	</div>
	...
	<input type="file" name="contentImages" multiple class="form-control"
	style="width: 30%;"/><br/>
	</div>
...
function addRewardForm(){
    ...
    <div style="display: flex; align-items: center; width: 25%;">
        <input type="text" name="amount" class="form-control" style="flex:1;" oninput="formatNumber(this);" value="0"/>
...
function formatNumber(input){
	...
	function addContentFile(){
		$("#content_files").append("<input type='file' name='contentImages' class='form-control' style='width: 30%;'/><br/>");
		contentCnt++;
	}
	
	var mainCnt = 1;
	function addMainFile(){
		$("#main_files").append("<input type='file' name='mainImages' class='form-control' style='width: 30%;'/><br/>");
		mainCnt++;
	}
...
//     }
    ...
    var rewardSubjects = document.getElementsByName("rewardSubjects");
    var rewardContents = document.getElementsByName("rewardContents");
